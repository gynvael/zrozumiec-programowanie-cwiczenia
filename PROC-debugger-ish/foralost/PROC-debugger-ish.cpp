 ...
 *
 *      Wypisuje takie informacje jak:
 *       Zdarzenia: 
 *        -> zaladowanie/wyladowanie biblioteki
 *        -> stworzenie/zamkniecie nowego procesu
 *        -> Wiekszosc wyjatkow wraz z ich opisem
 *        -> stworzenie/zamkniecie sie nowego watku 
 *
 *	Autor: Foralost (SZ. M.)
*/
